...
: artepulse.official@gmail.com
    ...
    {
        id: 15,
        title: "[하절기 근무시간 변경 안내]",
        date: "2026.04.08",
        views: 0,
        content: `안녕하세요, 아르떼펄스 운영지원팀입니다.

4/12(월)부터 하절기 근무시간이 적용됩니다.
임직원분들께서는 출퇴근 시간 변경 내용을 확인해주시기 바랍니다.

감사합니다.`
    },
    {
        id: 14,
        title: "[사내 복지프로그램 신청의 건]",
        date: "2026.04.06",
        views: 0,
        content: `안녕하세요. 아르떼펄스 인사팀입니다.

사내 교육 프로그램 신청이 시작되었습니다.
참여를 희망하시는 임직원분들께서는 기간 내 신청 바랍니다.

신청기간: 04.06(월)~04.12(일)
...
감사합니다.`
    },
    {
        ...
        views: 65,
        content: `안녕하세요,
따뜻한 봄을 맞아 스냅 클래스 할인 이벤트를 진행합니다.

기간: 4월 10일 ~ 4월 20일
혜택: 스냅 클래스 최대 30% 할인
관심 있던 클래스를 합리적인 가격으로 만나보세요.
...
많은 참여 부탁드립니다!`
    },
    {
        ...
        views: 41,
        content: `안녕하세요, 고객님.
보다 투명한 서비스 이용을 위해 환불 정책을 안내드립니다.

- 결제 후 7일 이내, 미수강 시 전액 환불 가능합니다.
- 일부 수강 시 환불 금액이 조정될 수 있습니다.

자세한 사항은 고객센터를 통해 확인 부탁드립니다.`
    },
    {
        id: 11,
